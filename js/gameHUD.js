...
const gameHUD = (() => {
    ...
    const DEPTHS = {
        BAR_BASE: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 17,
        BAR_OVERLAY: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 18,
        BUTTONS: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 20,
        ICONS: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 21,
        PROGRESS: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 17,
        TEXT: GAME_CONSTANTS.DEPTH_UPGRADE_TREE + 18
    };
