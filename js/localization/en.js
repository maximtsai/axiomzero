...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        volatile_payload: { name: 'VOLATILE PAYLOAD', desc: '[color=#8FD9F8]+75%[/color] [color=#E13500]EXPLODER[/color] blast radius.', popup: '+75% EXPLOSION RADIUS' },
        ...
        instability_mark: { name: 'INSTABILITY', desc: 'Cursor attacks [color=#bf24ff]mark[/color] enemies. Next non-cursor hit deals [color=#bf24ff]+12[/color] damage.', popup: 'INSTABILITY MARK' },
