...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        iterative_growth: { name: 'ITERATIVE GROWTH', desc: 'Permanently gain [color=#87FF02]+2[/color] MAX HP upon death.', popup: 'PERMANENT HP GAIN' },
        ...
        armor: { name: 'ARMOR', desc: 'Reduce damage taken from enemy attacks by [color=#8FD9F8]2.[/color]', popup: '+2 ARMOR' },
        ...
        instability_mark: { name: 'INSTABILITY', desc: 'Cursor hits [color=#bf24ff]mark[/color] enemies. Next non-cursor hit deals [color=#bf24ff]+10[/color] damage.', popup: 'INSTABILITY MARK' },
