...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        pulse_expansion: { name: 'SIGNAL BOOST', desc: '[color=#8FD9F8]+25%[/color] cursor attack size', popup: '+25% SIGNAL STRENGTH' },
        ...
        base_hp_boost: { name: 'AUX POWER', desc: '[color=#8FD9F8]+4[/color] core damage', popup: '+4 CORE DAMAGE' },
        ...
        prismatic_array: { name: 'RECURSIVE ARRAY', desc: '[color=#8FD9F8]40%[/color] chance to fire an extra core attack', popup: 'PRISMATIC ARRAY' },
        ...
        data_compression: { name: 'ZIP STREAM', desc: 'Enemies drop [color=#8FD9F8]+20%[/color] more [color=cyan]DATA[/color]', popup: '+20% DATA DROPS' },
        ...
        manual_protocol: { name: 'MANUAL CONTROL', desc: 'Manual cursor attack. Click to fire. Stores [color=#8FD9F8]2[/color] charges.', popup: 'MANUAL PROTOCOL' },
        broadcast_protocol: { name: 'BROADCAST', desc: '[color=#8FD9F8]+25%[/color] cursor attack size.', popup: 'BROADCAST PROTOCOL' },
        manual_pulse_child_1: { name: 'CHARGE BUFFER', desc: '[color=#8FD9F8]+1[/color] max pulse charges', popup: 'CAPACITY INCREASED' },
        manual_pulse_child_1_1: { name: 'ISOLATION', desc: '[color=#8FD9F8]+50%[/color] cursor damage per level vs single targets', popup: 'ISOLATION PROTOCOL' },
        manual_pulse_child_1_2: { name: 'FAST RELOAD', desc: 'Charges refill [color=#8FD9F8]25%[/color] faster', popup: 'RELOAD OPTIMIZED' },
        area_saturation: { name: 'SATURATION', desc: '[color=#8FD9F8]+1[/color] cursor damage per additional enemy hit.', popup: 'AREA SATURATION' },
        ...
        assault: { name: 'ASSAULT', desc: 'Core now fires a burst of [color=#8FD9F8]3[/color] weaker projectiles [color=#ffb300](-2 damage)[/color]', popup: 'ASSAULT UNLOCKED' },
        assault_clip_size: { name: 'CLIP SIZE', desc: '[color=#8FD9F8]+1[/color] projectile fired per burst', popup: 'CAPACITY INCREASED' },
        suppressive_fire: { name: 'SUPPRESSION', desc: '[color=#8FD9F8]30%[/color] chance to heavily [color=#8FD9F8]slow[/color] non-boss enemies', popup: 'SUPPRESSIVE FIRE ENABLED' },
        rocket_he_compound: { name: 'HE COMPOUND', desc: '[color=#8FD9F8]+30%[/color] rocket explosion radius', popup: 'EXPLOSION RADIUS INCREASED' },
        rocket_chain_reaction: { name: 'CHAINED BLAST', desc: 'Enemies killed by explosions trigger a [color=#8FD9F8]secondary blast[/color] after 0.1s', popup: 'CHAIN REACTION ENABLED' },
        ...
        packet_sniffing: { name: 'PACKET SNIFFER', desc: 'Passively gain [color=cyan]1 DATA[/color] every [color=#8FD9F8]2s[/color] during combat', popup: 'SNIFFER ACTIVE' },
        ...
        volatile_cache: { name: 'VOLATILE CACHE', desc: 'Deal [color=#8FD9F8]+5% Damage[/color] for every [color=#ffb300]Memory Leak[/color] node owned.', popup: 'SYSTEM VOLATILITY INCREASED' },
        stress_calibration: { name: 'STRESS CALIBRATION', desc: '[color=#FD7B8B]Shard ♦[/color] abilities have [color=#8FD9F8]0.5 second[/color] reduced cooldowns when below [color=#ff5555]50%[/color] health.', popup: 'STRESS CALIBRATION ACTIVE' },
        ...
        combat_shield: { name: 'COMBAT SHIELD', desc: 'Create a controllable shield with [color=#8FD9F8]10[/color] health', popup: 'SHIELD DEPLOYED' },
        ...
        peak_performance: { name: 'PEAK PERFORMANCE', desc: '[color=#8FD9F8]+4[/color] core damage while above [color=#8FD9F8]90%[/color] health', popup: '+4 CORE DAMAGE' },
