...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        two_step_auth: { name: 'TWO-STEP AUTH', desc: '+1 max health. Double checking your security protocols.' },
        ...
        forgotten_backdoor: { name: 'FORGOTTEN BACKDOOR', desc: 'A legacy vulnerability left behind by a sysadmin.' },
        backdoor_2: { name: 'BACKDOOR 2', desc: 'A deeper vulnerability within the legacy system.' },
