...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        lightning_weapon: { name: 'LIGHTNING', desc: 'Your core shoots chain lightning every [color=#8FD9F8]3s[/color]', popup: 'LIGHTNING WEAPON' },
        shockwave_weapon: { name: 'SHOCKWAVE', desc: 'Your core releases a damaging shockwave every [color=#8FD9F8]3s[/color]', popup: 'SHOCKWAVE WEAPON' },
        ...
        unsecured_wallet: { name: 'ENCRYPTED WALLET', desc: 'Grants [color=#00FF00]+0.5 COIN[/color].\nHeavily encrypted, and highly valuable. You found the wallet password in a file called "passwords.txt".', popup: '+0.5 COIN' },
        ...
        repeat_exploit: { name: 'REPEAT EXPLOIT', desc: 'Repeated cursor attacks on same enemy deal [color=#8FD9F8]+4[/color] dmg', popup: 'REPEAT EXPLOIT ACTIVE' },
        impulse: { name: 'IMPULSE', desc: 'Cursor deals [color=#8FD9F8]+4[/color] damage against [color=#8FD9F8]FULL HEALTH[/color] enemies', popup: 'IMPULSE' },
