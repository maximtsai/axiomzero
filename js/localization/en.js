...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        pulse_expansion: { name: 'SIGNAL STRENGTH', desc: '[color=#8FD9F8]+20%[/color] cursor pulse size', popup: '+20% SIGNAL STRENGTH' },
        overcharge: { name: 'OVERCHARGE', desc: '[color=#8FD9F8]+2[/color] cursor damage', popup: '+2 CURSOR DMG' },
        integrity: { name: 'INTEGRITY', desc: '[color=#87FF02]+4[/color] tower max health', popup: '+4 MAX HEALTH' },
        intensity: { name: 'INTENSITY', desc: '[color=#8FD9F8]+2[/color] tower basic damage', popup: '+2 DAMAGE' },
        focus: { name: 'COVERAGE', desc: '[color=#8FD9F8]+20%[/color] tower attack range', popup: '+20% ATTACK RANGE' },
        ...
        base_hp_boost: { name: 'AUXILIARY POWER', desc: '[color=#8FD9F8]+4[/color] tower basic damage', popup: '+4 TOWER DMG' },
        system_redundancy_new: { name: 'SYSTEM REDUNDANCY', desc: '[color=#87FF02]+5[/color] tower max health per level', popup: '+5 MAX HEALTH' },
        ...
        volatile_payload: { name: 'VOLATILE PAYLOAD', desc: 'Increases the size of BOMB explosions by [color=#8FD9F8]20%[/color] per level.', popup: '+20% EXPLOSION RADIUS' },
        ...
        laser_duration: { name: 'DURATION', desc: '[color=#8FD9F8]+0.5[/color] seconds to laser duration', popup: '+0.5s DURATION' },
        ...
        root_access: { name: 'ROOT ACCESS', desc: 'Acquiring root authority. Reduces all enemy damage by [color=#8FD9F8]10%[/color].', popup: 'ROOT ACCESS GRANTED' },
        label: {
            lore: 'LORE',
            gate: 'GATE',
            plus_data: '+DATA',
