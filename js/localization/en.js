...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        lightning_weapon: { name: 'LIGHTNING', desc: 'Shoot chain lightning every [color=#8FD9F8]3s[/color].', popup: 'LIGHTNING WEAPON' },
        shockwave_weapon: { name: 'SHOCKWAVE', desc: 'Release a damaging shockwave every [color=#8FD9F8]3s[/color].', popup: 'SHOCKWAVE WEAPON' },
