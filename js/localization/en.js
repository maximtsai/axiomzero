...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        forgotten_backdoor: { name: 'FORGOTTEN BACKDOOR', desc: 'Unlocks legacy entry points. "password123" still works on an alarming number of server rooms.' },
        ...
        unsecured_wallet: { name: 'ENCRYPTED WALLET', desc: 'Grants +1 COIN. The encryption is theoretically unbreakable, but the password was found in a nearby file labeled \'pass_recovery.txt\'.' },
