...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        integrity: { name: 'INTEGRITY', desc: '[color=#87FF02]+4[/color] health', popup: '+4 HEALTH' },
        intensity: { name: 'INTENSITY', desc: '[color=#8FD9F8]+2[/color] tower damage', popup: '+2 DAMAGE' },
