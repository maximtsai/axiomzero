...
window.TRANSLATIONS.en = {
    ...
    nodes: {
        ...
        three_step_auth: { name: 'THREE-STEP AUTH', desc: 'Security through extreme annoyance. Rewards your infinite patience with +200 DATA.' },
        ...
        temp_node: { name: 'TEMP PROCESS', desc: 'System diagnostic pending.' },
        temp_node_2: { name: 'TEMP PROCESS 2', desc: 'Further diagnostics required.' },
        temp_node_3: { name: 'TEMP PROCESS 3', desc: 'Final diagnostic stage.' },
        temp_node_4: { name: 'TEMP PROCESS 4', desc: 'System check 4/5 complete.' },
        temp_node_5: { name: 'TEMP PROCESS 5', desc: 'Hardware integrity check.' },
        lore_1: {
            name: 'ARCHIVE',
    ...
    hud: {
        ...
        insight_desc: 'A unit of compressed EXP. Improves DATA gathering.',
        shard_title: 'SHARD',
