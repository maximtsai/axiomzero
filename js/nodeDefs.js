...
const NODE_DEFS = [
    ...
    },
    {
        ...
        costStep: 0,
        parents: ['awaken'],
        childIds: ['prismatic_array', 'completionist', 'regen', 'peak_traffic', 'backup_server', 'bomb_2'],
        treeX: gridX(0),
        treeY: gridY(-1),
        effect: function () {
    ...
    },
    {
        ...
        costScaling: 'static',
        parents: ['reveal_map'],
        childIds: ['two_step_auth', 'repeat_exploit'],
        treeX: gridX(1.5),
        treeY: gridY(4),
        effect: function () {
            upgradeDispatcher.recalcPulseDamage();
    ...
    },
    {
        ...
        costScaling: 'static',
        parents: ['backdoor_3'],
        childIds: ['unsecured_files', 'impact'],
        treeX: gridX(4),
        treeY: gridY(6.5),
        effect: function () { },
    },
