...
const NODE_DEFS = [
    ...
    },
    {
        ...
        childIds: ['backdoor_2', 'trojan_access'],
        treeX: gridX(3.5),
        treeY: gridY(3.5),
        effect: function () { },
    },
    ...
    },
    {
        ...
        treeY: gridY(9.0),
        parents: ['privilege_escalation_3'],
        childIds: ['privilege_escalation_7', 'privilege_escalation_8'],
        isDuoBox: true,
        duoBoxTier: 3,
        shardId: 'artillery',
        effect: function () {
    ...
    {
        id: 'privilege_escalation_7',
        name: 'PRIVILEGE ESCALATION VII',
        icon: 'Skillicon14_09.png',
        description: 'Bypassing secondary biometrics.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['artillery'],
        childIds: ['privilege_escalation_9'],
        treeX: gridX(2.5),
        treeY: gridY(9.5),
        effect: function () { },
    },
    {
        id: 'privilege_escalation_9',
        name: 'PRIVILEGE ESCALATION IX',
        icon: 'Skillicon14_09.png',
        description: 'Cracking local keychain.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['privilege_escalation_7'],
        childIds: [],
        treeX: gridX(3.5),
        treeY: gridY(9.5),
        effect: function () { },
    ...
    {
        id: 'privilege_escalation_8',
        name: 'PRIVILEGE ESCALATION VIII',
        icon: 'Skillicon14_09.png',
        description: 'Injecting kernel-level hooks.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['artillery'],
        childIds: ['privilege_escalation_10'],
        treeX: gridX(2.5),
        treeY: gridY(8.5),
        effect: function () { },
    },
    {
        ...
        icon: 'Skillicon14_09.png',
        description: 'Securing permanent rootkit.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['privilege_escalation_8'],
        childIds: [],
        treeX: gridX(3.5),
        treeY: gridY(8.5),
        effect: function () { },
