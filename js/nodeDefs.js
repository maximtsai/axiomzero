...
const NODE_DEFS = [
    ...
    },
    {
        ...
        costStep: 0,
        parents: ['awaken'],
        childIds: ['prismatic_array', 'peak_traffic', 'backup_server', 'bomb_2', 'lore_3', 'zero_day_exploit', 'two_step_auth'],
        treeX: gridX(0),
        treeY: gridY(-1.5),
        effect: function () {
    ...
    },
    {
        ...
        costScaling: 'static',
        parents: ['system_redundancy_new'],
        childIds: ['diagnostic_analytics', 'threat_response'],
        treeX: gridX(-2.5),
        treeY: gridY(4.5),
        effect: function () {
            if (typeof tower !== 'undefined') {
    ...
    },
    {
        ...
        costType: 'data',
        costScaling: 'static',
        parents: ['impulse', 'packet_sniffing'],
    ...
    {
        id: 'milestones',
        name: t('nodes', 'milestones.name'),
        icon: 'Skillicon14_11.png',
        description: t('nodes', 'milestones.desc'),
        maxLevel: 1,
        baseCost: 150,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        costScaling: 'static',
        parents: ['reveal_map'],
        childIds: ['repeat_exploit', 'trojan_access'],
        treeX: gridX(1.5),
        treeY: gridY(4),
        effect: function () {
            upgradeDispatcher.recalcPulseDamage();
