...
const NODE_DEFS = [
...

    {
        ...
        costType: 'data',
        costScaling: 'static',
        parents: ['privilege_escalation_2', 'privilege_escalation_4'],
    ...
    {
        id: 'privilege_escalation_4',
        name: 'PRIVILEGE ESCALATION IV',
        icon: 'Skillicon14_09.png',
        description: 'Overriding local security policy.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        childIds: ['base_hp_boost', 'privilege_escalation_4'],
        treeX: gridX(-1),
        treeY: gridY(7),
        tooltipExtraWidth: 60,
        effect: function () {
