...
const NODE_DEFS = [
    {
        ...
        costStep: 0,
        parents: [],
        childIds: ['basic_pulse', 'integrity', 'intensity', 'crypto_mine_unlock', 'lore_1'],
        treeX: gridX(0),
        treeY: gridY(0),
        effect: function () {
            tower.awaken();
    ...
    },
    {
        ...
        childIds: ['backdoor_2', 'junk_data_2'],
        treeX: gridX(3),
        treeY: gridY(3.5),
        effect: function () { },
    },
    ...
    },
    {
        ...
        parents: ['overcharge'],
        monitorsDuoTier: 2,
        childIds: ['manual_pulse', 'wide_pulse', 'firewall_2'],
        treeX: gridX(-1),
        treeY: gridY(5.5),
        effect: function () { },
    },
    {
        ...
        name: 'FIREWALL 2',
        icon: 'Skillicon14_14.png',
        description: t('nodes', 'firewall_2.desc'),
        maxLevel: 1,
        baseCost: 1000,
        costType: 'data',
        costScaling: 'static',
