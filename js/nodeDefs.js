...
const NODE_DEFS = [
    ...
    },
    {
        ...
        name: 'TEMP PROCESS',
        icon: 'Skillicon14_09.png',
        description: 'System diagnostic pending.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        name: 'TEMP PROCESS 2',
        icon: 'Skillicon14_09.png',
        description: 'Further diagnostics required.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
...

    {
        ...
        name: 'TEMP PROCESS 3',
        icon: 'Skillicon14_09.png',
        description: 'Final diagnostic stage.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['temp_node_2', 'temp_node_4'],
        childIds: ['placeholder_duo_3', 'shredder_protocol', 'penetration_protocol', 'temp_node_5'],
        treeX: gridX(1.0),
        treeY: gridY(7.5),
        effect: function () { },
    },
    ...
    {
        id: 'shredder_protocol',
        name: 'SHREDDER PROTOCOL',
        icon: 'Skillicon14_06.png',
        description: t('nodes', 'shredder_protocol.desc'),
        popupText: 'SHREDDER PROTOCOL ACTIVE',
        popupColor: COLORS.COMBAT,
        maxLevel: 1,
        baseCost: 1,
        costType: 'shard',
        ...
        isDuoBox: true,
        duoBoxTier: 3,
        shardId: 'shredder_protocol',
        duoSiblingId: 'penetration_protocol',
    ...
    {
        id: 'penetration_protocol',
        name: 'PENETRATION PROTOCOL',
        icon: 'Skillicon14_11.png',
        description: t('nodes', 'penetration_protocol.desc'),
        popupText: 'PENETRATION PROTOCOL ACTIVE',
        popupColor: COLORS.COMBAT,
        maxLevel: 1,
        baseCost: 1,
        costType: 'shard',
        costScaling: 'static',
        duoSiblingId: 'shredder_protocol',
        treeX: gridX(1.0) + DUO_OFFSET,
        treeY: gridY(9.0),
        parents: ['temp_node_3'],
        childIds: ['temp_node_7', 'temp_node_8'],
        isDuoBox: true,
        duoBoxTier: 3,
        shardId: 'penetration_protocol',
        effect: function () {
            // upgradeDispatcher.recalcX();
        },
    },
    {
        ...
        name: 'TEMP PROCESS 7',
        icon: 'Skillicon14_09.png',
        description: 'Deep-layer integrity scans.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['penetration_protocol'],
        childIds: ['temp_node_9'],
        treeX: gridX(2.5),
        treeY: gridY(9.5),
        effect: function () { },
    },
    {
        ...
        name: 'TEMP PROCESS 9',
        icon: 'Skillicon14_09.png',
        description: 'Final substrate validation.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        name: 'TEMP PROCESS 8',
        icon: 'Skillicon14_09.png',
        description: 'Redundant signal verification.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
        parents: ['penetration_protocol'],
        childIds: ['temp_node_10'],
        treeX: gridX(2.5),
        treeY: gridY(8.5),
        effect: function () { },
    },
    {
        id: 'temp_node_10',
        name: 'TEMP PROCESS 10',
        icon: 'Skillicon14_09.png',
        description: 'System-wide parity check.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        name: 'TEMP PROCESS 4',
        icon: 'Skillicon14_09.png',
        description: 'System check 4/5 complete.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
    ...
    },
    {
        ...
        name: 'TEMP PROCESS 5',
        icon: 'Skillicon14_09.png',
        description: 'Hardware integrity check.',
        maxLevel: 1,
        baseCost: 0,
        costType: 'data',
        costScaling: 'static',
